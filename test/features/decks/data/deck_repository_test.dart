...
void main() {
  ...
  test('getAll excludes deleted decks', () async {
    await repo.create(_makeDeck(id: 'a', name: 'Active'));
    await repo.create(_makeDeck(id: 'b', name: 'To Delete'));
    await repo.delete('b');
  ...
  test('getChildren returns only direct children', () async {
    await repo.create(_makeDeck(id: 'parent'));
    await repo.create(_makeDeck(id: 'child-1', parentId: 'parent'));
    await repo.create(_makeDeck(id: 'child-2', parentId: 'parent'));
    await repo.create(_makeDeck(id: 'other'));
